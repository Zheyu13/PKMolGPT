...
class SmileDataset(Dataset):
    ...
    def __init__(self, args, data, stoi, block_size, aug_prob = 0.5, prop = None, scaffold = None, scaffold_max_len = None):
        self.stoi = stoi
        ...
        self.prop = prop
        self.sca = scaffold
        self.scaf_max_len = scaffold_max_len
        self.debug = args.debug
        self.tfm = SmilesEnumerator()
        self.aug_prob = aug_prob
        print('data has %d smiles, %d unique characters.' % (len(data), self.vocab_size))
