...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_size', type=int, default=252, help="Vocabulary size (will be inferred)", required=False)
    parser.add_argument('--block_size', type=int, default=200, help="Block size (will be inferred)", required=False)
    ...
    if "guacamol" in args.data_name:
        prop2value = {
            ...
            "qed_sas_logp_tpsa": [[0.7, 2.0, 4.0, 40.0], [0.5, 3.0, 4.0, 80.0], [0.5, 2.0, 4.0, 80.0], [0.7, 2.0, 4.0, 80.0]]
        }
    else:
        prop2value = {
            'logp': [-1.0, 3.0, 7.0], 'qed': [0.1, 0.4, 0.8], 'sas': [2.0, 4.0, 7.0], 'tpsa': [30.0, 70.0, 120.0],
            'sas_logp': [[4.0, 3.0], [2.0, 3.0], [4.0, -1.0], [4.0, 7.0], [7.0, 3.0], [7.0, 7.0], [2.0, 7.0], [7.0, -1.0], [2.0, -1.0]],
            'tpsa_logp': [[70.0, 3.0], [120.0, 3.0], [30.0, 3.0], [70.0, 7.0], [120.0, -1.0], [30.0, 7.0], [120.0, 7.0], [70.0, -1.0], [30.0, -1.0]],
            'tpsa_sas': [[70.0, 4.0], [70.0, 2.0], [120.0, 4.0], [30.0, 4.0], [30.0, 2.0], [120.0, 7.0], [120.0, 2.0], [70.0, 7.0], [30.0, 7.0]],
            'tpsa_logp_sas': [[70.0, 3.0, 4.0], [70.0, 3.0, 2.0], [30.0, 3.0, 4.0], [120.0, 3.0, 4.0], [30.0, 3.0, 2.0], [120.0, -1.0, 4.0], [70.0, 7.0, 4.0], [70.0, -1.0, 4.0]],
            'qed_sas_logp_tpsa': [[0.8, 4.0, 3.0, 70.0], [0.8, 2.0, 3.0, 70.0], [0.8, 2.0, 3.0, 30.0], [0.4, 4.0, 3.0, 120.0]]
        }
    ...
    # 3 Property only
        ...
        for c in prop_condition:
            ...
            # Calculate IntDiv1 for this property condition
            smiles_list = [Chem.MolToSmiles(m, isomericSmiles=True) for m in molecules]
            intdiv1_val = intdiv1(smiles_list, radius=2, nBits=2048, unique_valid_only=True, sample_max=20000, seed=42)
            print('IntDiv1: ', np.round(intdiv1_val, 6))
