...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_size', type=int, default=87, help="Vocabulary size (will be inferred)", required=False)
    parser.add_argument('--block_size', type=int, default=100, help="Block size (will be inferred)", required=False)
    ...
    if "guacamol" in args.data_name:
        ...
        prop2value = {
            "qed": [0.1, 0.3, 0.4, 0.6, 0.7],
            "sas": [2.0, 4.0, 6.0],
            "logp": [1.0, 2.0, 4.0, 6.0, 7.0],
            "tpsa": [40.0, 80, 120.0, 150, 200.0],
            "tpsa_logp": [[40.0, 1.0], [40.0, 4.0], [40.0, 7.0], [120.0, 1.0], [120.0, 4.0], [120.0, 7.0], [200.0, 1.0], [200.0, 4.0], [200.0, 7.0], [120, 6.0]],
            "sas_logp": [[1.0, 2.0], [1.0, 4.0], [1.0, 6.0], [4.0, 2.0], [4.0, 4.0], [4.0, 6.0], [7.0, 2.0], [7.0, 4.0], [7.0, 6.0], [2.0, 4.0]],
            "tpsa_sas": [[40.0, 2.0], [80.0, 2.0], [40.0, 4.0], [40.0, 6.0], [120.0, 2.0], [120, 4.0], [120, 6.0], [200, 2.0], [200.0, 4.0], [200.0, 6.0]],
            "tpsa_logp_sas": [[40.0, 1.0, 2.0], [40.0, 1.0, 6.0],
                              [40.0, 7.0, 6.0], [40.0, 6.0, 2.0],
                              [120.0, 7.0, 6.0], [120.0, 1.0, 6.0],
                              [80.0, 6.0, 4.0], [40.0, 2.0, 4.0],
                              [120.0, 1.0, 2.0], [120.0, 7.0, 2.0]]
        }
